...
const faculty_TYPES = ["Hospital", "Blood Lab"];
...
const validators = {
  name: (value) => (!value.trim() ? "faculty name is required" : ""),
  email: (value) => {
...
export default function facultyRegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Format faculty type to match backend enum
    const facultyType =
      formData.facultyType === "Hospital" ? "hospital" : "blood-lab";
    ...
    const submissionPayload = {
      ...
      facultyCategory: formData.facultyCategory,
      documents: formData.documents,
      operatingHours: formData.operatingHours,
      is24x7: formData.is24x7,
      emergencyServices: formData.emergencyServices,
      role: facultyType, // Set role to match faculty type
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Show success message with pending approval notice for facilities
        alert(
      ...
      alert(
        "Registration failed due to a network error. Please ensure the backend server is running.",
      );
    } finally {
      ...
      <div className="w-full max-w-3xl bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-red-700 text-white p-6">
          ...
          <p className="text-center mb-4 opacity-90">
            Register your faculty in 3 simple steps
          </p>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="facultyType" className="block font-medium mb-2">
                ...
                <div>
                  <label htmlFor="facultyCategory" className="block font-medium mb-2">
                    faculty Category
                  </label>
                  <select
                    id="facultyCategory"
