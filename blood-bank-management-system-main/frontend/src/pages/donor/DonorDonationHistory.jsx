...
const DonorDonationHistory = () => {
  ...
  const calculateStats = (data) => {
    ...
    // Find most frequent Faculty
    const FacultyCount = data.reduce((acc, item) => {
      const Faculty = item.Faculty || item.city || "Unknown";
      acc[Faculty] = (acc[Faculty] || 0) + 1;
      return acc;
    }, {});

    const favoriteFaculty = Object.keys(FacultyCount).reduce(
      (a, b) => (FacultyCount[a] > FacultyCount[b] ? a : b),
      "None"
    );
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <div className="relative max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search by Faculty, city, or blood group..."
