...
const CampCard = ({ camp }) => {
  ...
  // Assuming the populated hospital object has a 'name' field from the Faculty model
  const hospitalName = camp.hospital?.name || 'Associated Faculty Missing';
...
export const DonorCampsList = () => {
  ...
  const fetchCamps = useCallback(async () => {
    ...
    try {
      ...
      // to include the Faculty name in the response data.
