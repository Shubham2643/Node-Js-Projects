  ...
  useEffect(() => {
    const fetchHospitalData = async () => {
      try {
        ...
        const profileRes = await fetch("http://localhost:5001/api/Faculty/profile", {
          headers: { Authorization: `Bearer ${token}` },
        });

        console.log("Faculty getProfile route hit!");
        ...
        const h = profileData.hospital || profileData.Faculty || profileData;
